...
button.button {
  @apply relative appearance-none rounded pl-4 pr-10 py-[0.45rem] w-full text-left border border-medium-grey border-opacity-25 focus:ring-1 focus:border-main-green;
